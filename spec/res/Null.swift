...
public class Null: NSObject, NSCoding {
    // Original names


    public class func model(obj: AnyObject) -> Null {
        var instance: Null?
        if (obj is String) {
            instance = Null.init(str: obj as! String)
        } else if (obj is Dictionary<String, AnyObject>) {
            instance = Null.init(dict: obj as! Dictionary)
        }
        return instance!
    }
