...
NSString *const kSpecial_new = @"new";
...
- (instancetype)initWithDictionary:(NSDictionary *)dict {
    ...
    if (self && [dict isKindOfClass:[NSDictionary class]]) {
        ...
        self._new = [self objectOrNilForKey:kSpecial_new fromDictionary:dict];
    }
    return self;
}
...
- (NSDictionary *)dictionaryRepresentation {
    ...
    [mutableDict setValue:self._new forKey:kSpecial_new];
...
- (id)initWithCoder:(NSCoder *)aDecoder {
    ...
    self._new = [aDecoder decodeObjectForKey:kSpecial_new];
...
- (void)encodeWithCoder:(NSCoder *)aCoder {
    ...
    [aCoder encodeObject:__new forKey:kSpecial_new];
}
...
- (id)copyWithZone:(NSZone *)zone {
    ...
    if (copy) {
        ...
        copy._new = [self._new copyWithZone:zone];
    }
